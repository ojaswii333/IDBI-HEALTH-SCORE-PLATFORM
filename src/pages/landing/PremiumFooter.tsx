...
export default function PremiumFooter() {
  return (
    <footer className="responsive-padding" style={{ background: 'var(--bg-surface)', borderTop: '1px solid var(--border)' }}>
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        
        <div className="responsive-grid-3" style={{ marginBottom: 100 }}>
          ...
          <div>
            <h4 style={{ fontWeight: 600, marginBottom: 24, color: 'var(--text-primary)', fontSize: '1rem' }}>Product</h4>
          ...
          <div>
            <h4 style={{ fontWeight: 600, marginBottom: 24, color: 'var(--text-primary)', fontSize: '1rem' }}>Enterprise</h4>
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            <h4 style={{ fontWeight: 600, marginBottom: 24, color: 'var(--text-primary)', fontSize: '1rem' }}>Bank</h4>
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
