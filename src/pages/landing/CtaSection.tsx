    ...
    <section ref={containerRef} className="responsive-padding" style={{ background: 'var(--bg-app)', position: 'relative', overflow: 'hidden' }}>
      ...
      >
        ...
        <div className="responsive-flex" style={{ justifyContent: 'center' }}>
          <Link to="/login" className="btn btn-primary" style={{ padding: '24px 48px', fontSize: '1.125rem', borderRadius: 100, display: 'flex', alignItems: 'center', gap: 12, fontWeight: 600, background: 'var(--text-primary)', color: 'white', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
            Start Assessment <ArrowRight size={20} />
          </Link>
          <Link to="/login" style={{ padding: '24px 32px', fontSize: '1.125rem', fontWeight: 600, color: 'var(--text-primary)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
            Talk to an Expert
          </Link>
        </div>
      </motion.div>
